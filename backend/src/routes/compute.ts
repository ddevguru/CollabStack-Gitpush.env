...
router.post('/jobs', async (req: AuthRequest, res: Response, next: NextFunction) => {
...
router.get('/jobs/:jobId', async (req: AuthRequest, res: Response, next: NextFunction) => {
...
router.get('/schedule/available', async (req: AuthRequest, res: Response, next: NextFunction) => {
