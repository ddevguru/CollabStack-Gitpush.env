...
router.post('/projects/:projectId/repo', async (req: AuthRequest, res, next) => {
...
router.post('/projects/:projectId/push', async (req: AuthRequest, res, next) => {
  await githubController.pushToBranch(req, res, next);
});

router.get('/projects/:projectId/branches', async (req: AuthRequest, res, next) => {
  await githubController.getBranches(req, res, next);
});

router.post('/projects/:projectId/branches/:branchName/push', async (req: AuthRequest, res, next) => {
